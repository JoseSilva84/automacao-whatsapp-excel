...
module.exports = {
  ...
  zproTargetNumber: process.env.ZPRO_TARGET_NUMBER || process.env.ZPRO_SELF_NUMBER || '',
  ...
  agendaReminderEnabled: bool(process.env.AGENDA_REMINDER_ENABLED, false),
  agendaReminderMinutesBefore: Number(process.env.AGENDA_REMINDER_MINUTES_BEFORE || 15),
  agendaReminderCheckIntervalSeconds: Number(process.env.AGENDA_REMINDER_CHECK_INTERVAL_SECONDS || 60),
  agendaReminderSheetRange: process.env.AGENDA_REMINDER_SHEET_RANGE || 'A1:ZZ80',
  agendaReminderSentFile: process.env.AGENDA_REMINDER_SENT_FILE || 'agenda-reminders-sent.json',
